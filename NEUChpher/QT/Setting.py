...
class Ui_Setting(object):
    ...
    def retranslateUi(self, Setting):
        ...
        self.lineIp.setText(_translate("Setting", NEUChpher.host))
        self.line_Port.setText(_translate("Setting", str(NEUChpher.port)))
    ...
    def setHostAndPort(self):
        ...
        if not self.line_Port.text().isdigit():
            ...
            return
        NEUChpher.host = self.lineIp.text()
        NEUChpher.port = int(self.line_Port.text())
        message = QtWidgets.QMessageBox()
